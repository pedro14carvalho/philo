...
This will automatically compile the program with the appropriate -pthread flag, alongside the common flags used in every school 42 C project (-Wall -Werror -Wextra).
